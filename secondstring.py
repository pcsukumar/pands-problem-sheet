#This program ask the user to input a string and output every second letter in reverse order.
#Author: Prasanth Sukumar

stringToReverse = input('Please enter a string:') #Asking user to enter a string

reversedString = stringToReverse[::-2] #How to reverse a sting found on this page; https://www.w3schools.com/python/python_howto_reverse_string.asp
